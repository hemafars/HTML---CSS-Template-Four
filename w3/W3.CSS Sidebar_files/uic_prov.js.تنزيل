...
let provider = (adRnd < 0.85 ? "snigel" : adRnd < 0.95 ? "bsa" : "google");
let pageType = "";
const uic_prov_pre = (pt) => {
  if (pt == "default" || pt == "tryit" || pt == "tryitdb" || pt == "exercise" || pt == "xrcise" || pt == "video" || pt == "explainer") { pageType = pt; }
  ...
  if ( !_uic_u_ok() || (_uic_u_ok() && (pageType == "video" || pageType == "explainer"))) {
    (function(){
